<?php
$section  = 'header_style_18';
$priority = 1;
$prefix   = 'header_style_18_';
...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-18 .page-header-inner',
...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-18 .menu--primary a',
		),
	),
) );
...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-18 .menu--primary .menu__container > li > a',
...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
            ...
            .header-18 .menu--primary .menu__container > li.current-menu-item > a',
			'property' => 'background-color',
		),
	),
) );
