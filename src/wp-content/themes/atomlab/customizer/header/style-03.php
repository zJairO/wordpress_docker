...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'label'       => esc_html__( 'Cart Badge Background Color', 'atomlab' ),
	'description' => esc_html__( 'Controls the background color of cart badge.', 'atomlab' ),
	'section'     => $section,
	'priority'    => $priority ++,
	'transport'   => 'auto',
	'default'     => '#fff',
	'output'      => array(
		array(
			'element'  => '.header-03.headroom--top .mini-cart-icon:after',
...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'label'       => esc_html__( 'Cart Badge Color', 'atomlab' ),
	'description' => esc_html__( 'Controls the color of cart badge.', 'atomlab' ),
	'section'     => $section,
	'priority'    => $priority ++,
	'transport'   => 'auto',
	'default'     => '#222',
	'output'      => array(
		array(
			'element'  => '.header-03.headroom--top .mini-cart .mini-cart-icon:after',
			'property' => 'color',
		),
	),
) );
...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-03 .menu--primary a',
		),
	),
) );
...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-03 .menu--primary .menu__container > li > a',
			'property' => 'background-color',
		),
	),
) );
