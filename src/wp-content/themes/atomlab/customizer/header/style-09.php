...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'label'     => esc_html__( 'Info List', 'atomlab' ),
	'section'   => $section,
	'priority'  => $priority ++,
	'choices'   => array(
		'labels' => array(
	...
	'default'   => array(
		array(
			'title'      => '0122 8899900',
			'sub_title'  => 'Info@example.com',
			'icon_class' => 'ion-ios-telephone-outline',
		),
		array(
			'title'      => '219 Amara Fort Apt. 394',
			'sub_title'  => 'New York, NY 941',
			'icon_class' => 'ion-ios-location-outline',
		),
		array(
			'title'      => '8:00AM - 6:00PM',
			'sub_title'  => 'Monday to Saturday',
			'icon_class' => 'ion-ios-timer-outline',
		),
		array(
			'title'      => '+122 123 4567',
			'sub_title'  => 'Sales Department',
			'icon_class' => 'ion-ios-chatboxes-outline',
		),
	),
	'fields'    => array(
		'title'      => array(
		...
		'sub_title'  => array(
			'type'    => 'text',
			'label'   => esc_html__( 'Sub Title', 'atomlab' ),
			'default' => '',
		),
		'icon_class' => array(
			'type'    => 'text',
...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-09 .menu--primary .menu__container > li > a',
...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
            ...
            .header-09 .menu--primary .menu__container > li.current-menu-item > a',
			'property' => 'background-color',
		),
	),
) );
