...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => defined( 'ATOMLAB_DEMO_BUTTON_TEXT' ) ? ATOMLAB_DEMO_BUTTON_TEXT : esc_html__( 'Get Started' ),
) );
...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => defined( 'ATOMLAB_DEMO_BUTTON_LINK' ) ? ATOMLAB_DEMO_BUTTON_LINK : '#',
) );
...
Atomlab_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => defined( 'ATOMLAB_DEMO_BUTTON_LINK_TARGET' ) ? ATOMLAB_DEMO_BUTTON_LINK_TARGET : '0',
	'choices'  => array(
		'0' => esc_html__( 'No', 'atomlab' ),
		'1' => esc_html__( 'Yes', 'atomlab' ),
	),
