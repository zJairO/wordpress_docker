...
if ( ! class_exists( 'Atomlab_VC_Icon_Linea' ) ) {
	class Atomlab_VC_Icon_Linea {
		...
		public function __construct() {
			...
			add_filter( 'vc_iconpicker-type-linea', array( $this, 'add_fonts' ) );
		...
		public function vc_element_enqueue( $font ) {
			switch ( $font ) {
				case 'linea':
					wp_enqueue_style( 'font-linea', ATOMLAB_THEME_URI . '/assets/fonts/linea/font-linea.min.css', null, null );
					break;
			}
		}
