...
if ( ! class_exists( 'Atomlab_VC_Icon_Themify' ) ) {
	class Atomlab_VC_Icon_Themify {
		...
		public function vc_element_enqueue( $font ) {
			switch ( $font ) {
				case 'themify':
					wp_enqueue_style( 'font-themify', ATOMLAB_THEME_URI . '/assets/fonts/themify/font-themify.min.css', null, null );
					break;
			}
		}
		...
		public function add_fonts( $icons ) {
			$new_icons = array(
				esc_html__( 'Arrows & Direction Icons', 'atomlab' ) => array(
				...
				esc_html__( 'Web App Icons', 'atomlab' )            => array(
					array( 'ti-wand' => 'wand' ),
					array( 'ti-save' => 'save' ),
				...
				esc_html__( 'Control Icons', 'atomlab' )            => array(
				...
				esc_html__( 'Text Editor', 'atomlab' )              => array(
				...
				esc_html__( 'Layout Icons', 'atomlab' )             => array(
				...
				esc_html__( 'Brand Icons', 'atomlab' )              => array(
