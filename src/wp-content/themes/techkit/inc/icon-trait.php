...
trait IconTrait {
  ...
  {
    $font_awesomes = self::get_font_awesome_4_icons();
  ...
  public static function get_flaticon_icons()
  {
    return [
	"flaticon-next" => "next",
	"flaticon-previous" => "previous",
	"flaticon-clock" => "clock",
	"flaticon-phone-call" => "phone-call",
	"flaticon-envelope" => "envelope",
	"flaticon-location" => "location",
	"flaticon-create" => "create",
	"flaticon-management" => "management",
	"flaticon-secure-shield" => "secure-shield",
	"flaticon-analytics" => "analytics",
	"flaticon-client" => "client",
	"flaticon-deadline" => "deadline",
	"flaticon-settings" => "settings",
	"flaticon-team" => "team",
	"flaticon-medal" => "medal",
	"flaticon-graphic-design" => "graphic-design",
	"flaticon-web-development" => "web-development",
	"flaticon-analysis" => "analysis",
	"flaticon-cyber-security" => "cyber-security",
	"flaticon-website" => "website",
	"flaticon-android" => "android",
      "flaticon-apple" => "apple",
      "flaticon-programing" => "programing",
      "flaticon-smartwatch" => "smartwatch",
      "flaticon-lifeline-on-a-tv-monitor-screen-of-a-medical-program" => "medical-program",
      "flaticon-left-quote" => "left-quote",
      "flaticon-3d-file" => "3d-file",
      "flaticon-coding" => "coding",
      "flaticon-code" => "code",
      "flaticon-package" => "package",
      "flaticon-cpu" => "cpu",
      "flaticon-guarantee" => "guarantee",
      "flaticon-right-quote" => "right-quote",
      "flaticon-link" => "link",
      "flaticon-development" => "development",
      "flaticon-analysis-1" => "analysis-1",
      "flaticon-pie-chart" => "pie-chart",
      "flaticon-hierarchical-structure" => "hierarchical-structure",
      "flaticon-infrastructure" => "infrastructure",
      "flaticon-software" => "software",
      "flaticon-settings-1" => "settings-1",
      "flaticon-pdf-file" => "pdf-file",
      "flaticon-file" => "file",
      "flaticon-menu" => "menu",
    ];
  }
