...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Customizer_Google_Fonts_Controls extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'rttheme-typography-controls-js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/typography/assets/typography.js', array( 'rttheme-select2-js' ), '1.2', true );
			wp_enqueue_style( 'rttheme-typography-controls-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/typography/assets/typography.css', array(), '1.1', 'all' );
