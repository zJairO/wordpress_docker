...
?>
<div class="team-default team-multi-layout-2 owl-wrap <?php echo esc_attr( $data['button_style'] ); ?> team-slider-<?php echo esc_attr( $data['style'] );?> <?php echo esc_attr( $slider_nav_class ); ?><?php echo esc_attr( $slider_dot_class ); ?>">
					...
					<div class="rtin-content-wrap">
						...
						<div class="mask-wrap">
							<div class="rtin-content">
								<h3 class="rtin-title"><a href="<?php the_permalink();?>"><?php the_title();?></a><?php if ( $data['designation_display'] ) { ?><span> - <?php echo esc_html( $position );?></span><?php } ?></h3>
							</div>
						</div>
					</div>
				</div>
