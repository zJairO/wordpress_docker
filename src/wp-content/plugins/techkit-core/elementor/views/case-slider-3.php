...
?>
<div class="case-default case-multi-layout-3 <?php echo esc_attr( $data['button_style'] ); ?> owl-wrap case-slider-<?php echo esc_attr( $data['layout'] );?> <?php echo esc_attr( $slider_nav_class ); ?><?php echo esc_attr( $slider_dot_class ); ?>">
		...
		?>
			<div class="rtin-item <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $j );?>s" data-wow-duration="<?php echo esc_attr( $k );?>s">
				...
				<div class="rtin-content">		
					...
					<?php } ?>
					<span><a class="link" href="<?php the_permalink();?>"><i class="fas fa-plus"></i></a></span>
				</div>
			</div>
		<?php $j = $j + 0.2; $k = $k + 0.2; } ?>
	<?php } ?>
