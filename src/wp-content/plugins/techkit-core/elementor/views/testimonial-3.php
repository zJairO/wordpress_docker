...
?>
<div class="default-testimonial rtin-testimonial-3 owl-wrap <?php echo esc_attr( $data['button_style'] ); ?> <?php echo esc_attr( $slider_nav_class ); ?><?php echo esc_attr( $slider_dot_class ); ?>">
