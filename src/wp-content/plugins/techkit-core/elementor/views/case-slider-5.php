...
?>
<div class="case-default case-multi-layout-5 <?php echo esc_attr( $data['button_style'] ); ?> owl-wrap case-slider-<?php echo esc_attr( $data['layout'] );?> <?php echo esc_attr( $slider_nav_class ); ?><?php echo esc_attr( $slider_dot_class ); ?>">
