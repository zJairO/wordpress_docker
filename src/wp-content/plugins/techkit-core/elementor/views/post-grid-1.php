	...
	<?php $i = $data['delay']; $j = $data['duration']; 
		...
		<?php while ( $query->have_posts() ) : $query->the_post();?>
			...
			<div class="<?php echo esc_attr( $col_class );?>">
				<div class="rtin-item-post <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">
					<div class="rtin-img">
