...
?>
<div class="case-default case-multi-layout-6 case-<?php echo esc_attr( $data['layout'] );?>">
		...
		<div class="<?php echo esc_attr( $col_class ) ?>">
			<div class="rtin-item <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $j );?>s" data-wow-duration="<?php echo esc_attr( $k );?>s">
				<div class="rtin-figure">
					...
					<span><a class="link" href="<?php the_permalink();?>"><?php echo esc_html_e('View More','techkit-core') ?></a></span>
					<?php } ?>
				</div>
